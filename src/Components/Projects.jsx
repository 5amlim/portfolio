    ...
    return (
        <section>
            ...
            <motion.div className="project"style={{ y }}>
                ...
                <div class="max-w-sm p-6 bg-white/80 border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">

                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{name.discription}</p>
                    <motion.a whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} href={name.link} target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gradient-to-r from-violet-500/90 to-blue-900 rounded-lg hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Demo
                        <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </motion.a> &nbsp;
                    <motion.a whileHover={{ scale: 1.3 }} whileTap={{ scale: 0.9 }} href={name.github} target="_blank" rel="noopener noreferrer" class="float-right text-gray-500 hover:text-violet-900 dark:hover:text-white">
                        ...
                        <span class="sr-only">GitHub Link</span></motion.a>
                </div>
                {/* <p className="float-right box-content bg-blue-400/80 h-auto w-80 text-black">{name.discription}</p> */}
            </motion.div>
            {/* <motion.h2 className="text-main float-right box-content h-auto w-80 p-0box-decoration-clone  text-black" style={{ y }}>{name.discription}</motion.h2> */}
