            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-4">
                ...
                <div className="mx-auto w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="flex items-center justify-center mt-4 space-x-6 sm:justify-center md:mt-0 overflow-x-scroll mx-0">
                        ...
                        <a href="https://www.instagram.com/5amlim/" target="_blank" rel="noopener noreferrer" className="social-wrapper text-gray-400 hover:text-violet-700 dark:hover:text-white">
                        ...
                        <a href="https://github.com/5amlim" target="_blank" rel="noopener noreferrer" className="social-wrapper text-gray-400 hover:text-purple-900 dark:hover:text-white">
                        ...
                        <a href="https://www.linkedin.com/in/samnanghay/" target="_blank" rel="noopener noreferrer" className="social-wrapper text-gray-400 hover:text-gray-900 dark:hover:text-white">
