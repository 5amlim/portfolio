  ...
  return (
    <div className="components">
      ...
      <p className='text-main indent-8 text-justify'>
        ...
        Aside from coding, I enjoy reading and spending time with my dogs <a href="https://www.instagram.com/toastednchipped/" target="_blank" rel="noopener noreferrer">Toast and Chip.</a>
      </p>
      <br></br>
      ...
      <motion.div variants={container} initial="hidden" animate="show" className='skills flex justify-evenly overflow-x-auto overflow-auto mx-0'>
        ...
        <div className="flex ">
          ...
          <div className="image-wrapper">
            ...
            <p className="hide-text">Postgres</p>
          </div>
          {/* <div className="image-wrapper">
